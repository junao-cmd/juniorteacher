...
O **Junior** é um amigo que te ensina inglês conversando, feito com Claude.
...
- **No WhatsApp** (`whatsapp_bot.py`): o Junior conversa com você no WhatsApp e puxa papo sozinho
  ao longo do dia.
...
O Junior conversa com você pela API oficial do WhatsApp (Meta Cloud API). Ele:
...
| `CHECKIN_TIMES`            | `09:00,12:30,19:30`  | Horários em que o Junior puxa conversa (vazio desativa)             |
...
Pronto: mande um "Hi!" para o número do bot e o Junior se apresenta.
...
Se vocês ficarem mais de 24 h sem conversar, no próximo horário o Junior manda um **template**
...
Por enquanto o Junior lê só mensagens de texto; se você mandar áudio ou imagem, ele pede para você
escrever.
